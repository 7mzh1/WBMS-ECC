...
Public Class INVOICE
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles b_display.Click
        ...
        cmd.CommandText = "curspkg_join.getinv_det"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles b_save.Click
        ...
        Try
            ...
            cmd.Connection = conn
            cmd.Parameters.Clear()
            cmd.CommandText = "gen_iwb_dsd.gen_wbms_invoice"
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles b_searchdoc.Click
        Try
            ...
            Dim cns As Integer
            sql = " select count(itemcode) cnt from STMUL_GR_IV WHERE invdocno = " & Me.tb_rdocno.Text
            ...
            End If
            sql = " select * from STMUL_GR_IV WHERE invdocno = " & Me.tb_rdocno.Text _
        ...
        Try
            ...
            End If
                ...
                Try
                    ...
                    cmd.Connection = conn
                    cmd.Parameters.Clear()
                    cmd.CommandText = "curspkg_join.get_invoice"
                    cmd.CommandType = CommandType.StoredProcedure
                ...
                cmd.Connection = conn
                cmd.Parameters.Clear()
                cmd.CommandText = "gen_iwb_dsd.gen_wbms_sap_inv"
                cmd.CommandType = CommandType.StoredProcedure
                Try
