...
Partial Public Class DataSet4
    ...
    Partial Public Class STWBMIBDS_PRDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Default ReadOnly Property Item(ByVal index As Integer) As STWBMIBDS_PRRow
            Get
...
Namespace DataSet4TableAdapters
    ...
    Partial Public Class STWBMIBDS_PRTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet4.STWBMIBDS_PRDataTable, ByVal vintdocno As Decimal, ByVal div_code As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal vintdocno As Decimal, ByVal div_code As String) As DataSet4.STWBMIBDS_PRDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(vintdocno,Decimal)
            If (div_code Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(div_code,String)
            End If
            Dim dataTable As DataSet4.STWBMIBDS_PRDataTable = New DataSet4.STWBMIBDS_PRDataTable()
